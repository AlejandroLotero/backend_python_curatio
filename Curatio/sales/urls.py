...
urlpatterns = [
    ...
    # CARTSHOPS
    # =========================
    path("v1/cartshops/", api_views.cartshops_resource, name="cartshops_resource"),
    path("v1/cartshops/<int:sale_id>/", api_views.cartshop_detail_resource, name="cartshop_detail_resource"),
