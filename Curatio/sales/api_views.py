...
#         raise ValueError({"payment_type": ["Invalid payment type."]})
...
#         raise ValueError({"status": ["Invalid sale status."]})
...
#                 {
#                     "lines": [
#                         f"Line {index + 1}: medication '{medicamento.nombre}' is not available for sale."
#                     ]
#                 }
#             )
...
#     Objetivos visuales:
#     - apariencia formal tipo factura comercial
#     - encabezado institucional
#     - bloques de información bien definidos
#     - tabla de detalle clara
...
#     def divider():
#         """
#         Línea divisoria horizontal suave.
#         """
...
#         """
#         Tarjeta compacta de información.
#         """
...
#     Características:
#     - formato angosto similar a impresora térmica
#     - cabecera premium con identidad comercial
#     - detalle compacto por producto
#     - total destacado
#     - bloque de validación de pago
#     - código QR con trazabilidad básica
#     """
#     output = BytesIO()
...
#         """
#         Bloque visual pequeño tipo badge.
#         """
...
#     - se asigna el primer usuario activo con rol Administrador o Farmaceuta
#     - esto permite persistir la compra del cliente en el mismo modelo Venta
#       sin romper la regla de que cliente y vendedor deben ser distintos

#     Más adelante, si el negocio lo requiere, esto puede reemplazarse por:
#     - una asignación por sede
#     - un usuario interno del sistema
#     - una cola de asignación operativa
#     """
#     return (
#         User.objects.filter(
#             rol__in=["Administrador", "Farmaceuta"],
...
#     Flujo pensado para ADMIN / FARMACEUTA:
#     - se ingresa el tipo de documento
#     - se ingresa el número de documento
#     - si el cliente existe y está activo, se retorna su información básica
#     """
#     if not _usuario_puede_vender(request.user):
#         return _forbidden_sales_response()
...
#     Reglas:
#     - Administrador puede descargar cualquier factura.
#     - Farmaceuta solo puede descargar facturas de sus ventas.
#     - Cliente solo puede descargar sus propias facturas.

#     Formato de salida:
#     - Checkout web del cliente -> factura empresarial
#     - Venta interna -> comprobante tipo POS
#     """
#     sale = get_object_or_404(
#         Venta.objects.select_related(
#             "cliente",
