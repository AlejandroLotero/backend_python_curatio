...
# MODELOS DE PRODUCTOS / MEDICAMENTOS / PROVEEDORES
# --------------------------------------------------
# Esta implementación queda alineada con la BD final basada en el dump,
# conservando lo más posible su estructura y extendiéndola según los RQ.
#
# Notas importantes:
# - Se respetan nombres de tablas del dump mediante db_table.
# - Se respetan nombres de columnas del dump mediante db_column.
# - Se agregan campos necesarios por RQ: activo, trazabilidad, historiales e imagen.
# - La imagen NO se guarda en base de datos: se guarda en el filesystem del backend.
# - En la BD solo queda la ruta del archivo mediante ImageField.
